            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    <button class="flex items-center gap-2 px-3 py-2 text-gray-600 rounded-lg hover:bg-gray-200 focus:outline-none">
                        ...
                        <img src="{{ asset('storage/images/profile_pictures/' . (auth()->user()->profile_picture ?? 'default-avatar.png')) }}" alt="User Profile" class="w-10 h-10 rounded-full border-2 border-emerald-600 object-cover">
                    </button>
