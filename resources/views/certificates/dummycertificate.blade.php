...
@php
  ...
  $recipient    = $recipient    ?? ('Budi Santoso');
  $deptText     = $deptText     ?? ('Teknologi Informasi');

  $startDate    = $startDate    ?? ('01 Juni 2025');
  $endDate      = $endDate      ?? ('31 Agustus 2025');
...
<body>
  <div class="viewer">
    <div class="page" aria-label="Sertifikat ">
      {{-- background div memakai data URI / URL $bg --}}
      <div class="bg" style="background-image:url('');" role="img" aria-label="Background "></div>
      ...
      <main class="content">
        <div class="content-inner" style="top:{{ (int)($contentOffset ?? 0) }}px;">
          ...
          <p class="desc">
            Telah menyelesaikan magang bidang <span>{{ $deptText }}</span> di  selama
