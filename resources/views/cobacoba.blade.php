...
<head>
  ...
  <style>
    ...
    .stamp { width: 100px; height: 100px; margin: 6px auto 0; opacity: .25; position: absolute; right: 10px; bottom: 0; opacity: 0.25; }
    ...
    <div class="letter">
      ...
      <div class="sign-wrap">
        <div class="sign" style="position: relative;">
          ...
          <div style="font-weight:700; margin-top: 5px;">{{ $leaderName }}</div>
