...
<div class="container mx-auto p-6">
  <h1 class="text-2xl font-semibold text-primary-700 mb-6">Edit Feedback</h1>
  ...
  <form action="{{ route('admin.feedback.update', $feedback->id) }}" method="POST">
    ...
    <div class="mb-4">
      <label for="feedback" class="block text-sm font-medium text-primary-700 mb-2">Feedback</label>
    ...
    <div class="mb-4">
      ...
      <a href="{{ route('admin.feedback.index') }}" class="ml-4 text-primary-700 hover:underline">Kembali ke Daftar Feedback</a>
    </div>
  </form>
</div>
@endsection
